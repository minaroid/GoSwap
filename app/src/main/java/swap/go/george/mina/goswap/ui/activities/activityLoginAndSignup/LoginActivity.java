...
public class LoginActivity extends AppCompatActivity implements LoginActivityMVP.view{
    ...
    public void loginBtnClicked(View view) {
        ...
        if (emailText.equals("") || passText.equals("")) {
            ...
            call = API.getItems().checkLogin(emailText, passText);
            call.enqueue(new Callback<ArrayList<UserInfo>>() {
                @Override
                public void onResponse(Call<ArrayList<UserInfo>> call, Response<ArrayList<UserInfo>> response) {
                    ...
                    if (state.equals("founded")) {
                        ...
                        LoginActivity.this.showMessage("incorrect password");
                    } else if (state.equals("not")) {
                        LoginActivity.this.showMessage("this email not exist try sign up");
                    }
                }
